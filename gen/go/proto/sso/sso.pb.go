...
func (x *GetEmailRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"(\n" +
	"\x10GetEmailResponse\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email2\xe6\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x129\n" +
	"\bGetEmail\x12\x15.auth.GetEmailRequest\x1a\x16.auth.GetEmailResponseB6Z4github.com/MaynixX/sso-protos/gen/go/proto/sso;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*GetEmailRequest)(nil),  // 6: auth.GetEmailRequest
	(*GetEmailResponse)(nil), // 7: auth.GetEmailResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	6, // 3: auth.Auth.GetEmail:input_type -> auth.GetEmailRequest
	...
	7, // 7: auth.Auth.GetEmail:output_type -> auth.GetEmailResponse
